...
class LogBackupServiceTest {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(logBackupService, "timeZone", TEST_TIMEZONE);
    }
    ...
    @Test
    @DisplayName("어제 날짜의 로그 파일이 존재하지 않을 시 업로드하지 않음 성공")
    ...
    @Test
    @DisplayName("S3 업로드 중 예외가 발생해도 로컬 파일 보존 성공")
